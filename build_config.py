...
def process_config():
        ...
        data_arg.add_argument('--max_vocab_cnt', type=int, default=20000, help="if num of vocab is exceeded, then filter by freq")
        ...
        data_arg.add_argument('--gcdc_domain', type=str, default='Yelp')  # Clinton, Enron, Yahoo, Yelp
        ...
        net_arg.add_argument('--embed_size', type=int, default=300)  # for general pretariend, but emb for essay is pre-fixed in the code
        ...
        net_arg.add_argument('--encoder_type', type=str, default='xlnet', help='lstm, gru, bert, reg_lstm, transf, xlnet, bart')
        ...
        net_arg.add_argument('--target_model', type=str, default="ilcr_lcsd", help='emnlp18, conll17, ilcr_sent_avg, ilcr_lcsd')
        ...
        train_arg.add_argument('--loss_type', type=str, default="CrossEntropyLoss")  # CrossEntropyLoss, MSELoss, nLLloss, multilabelsoftmarginloss ...
        train_arg.add_argument('--eval_type', type=str, default="accuracy")  # accuracy, qwk, fscore
