...
def process_config():
        ...
        net_arg.add_argument('--target_model', type=str, default="ilcr_lcsd", 
                help='emnlp18, conll17, ilcr_sent_avg, ilcr_lcsd')
        ...
        train_arg.add_argument('--max_epoch', type=int, default=70)
