...
def process_config():
        ...
        data_arg.add_argument('--max_vocab_cnt', type=int, default=40000, help="if num of vocab is exceeded, then filter by freq")
        ...
        net_arg.add_argument('--rnn_cell_size', type=int, default=100)  # can be ignored as encoder (e.g., bert)
